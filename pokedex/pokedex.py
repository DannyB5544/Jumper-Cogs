...
Explore
 ...
 Sign out
 Watch 102
  Star 662  Fork 564 Cog-Creators/Red-DiscordBot
 Code  Issues 55  Pull requests 28  Projects 6 Insights 
Branch: develop Find file Copy pathRed-DiscordBot/cogs/audio.py
fc32524  on 26 Aug
@alexwh alexwh [Audio] Support for YouTube URLs with timestamp (#919)
18 contributors @Twentysix26 @tekulvw @irdumbs @calebj @sedders123 @Kowlin @Jan200101 @Canule @phantium @palmtree5 @Markolie @FrostTheFox @americanhanko @Chovin @SomeFixItDude @Aioxas @Eslyium @alexwh
RawBlameHistory     
2387 lines (1979 sloc)  85.8 KB
import discord
